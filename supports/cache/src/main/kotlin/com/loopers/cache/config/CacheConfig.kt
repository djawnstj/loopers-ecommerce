...
import com.loopers.cache.redis.SortedCacheRedisRepository
...
class CacheConfig {
    ...
    @Order(Ordered.HIGHEST_PRECEDENCE)
    @Bean
    fun sortedCacheRepository(redisTemplate: RedisTemplate<String, String>, objectMapper: ObjectMapper): SortedCacheRepository =
        SortedCacheRedisRepository(redisTemplate, objectMapper)
}
